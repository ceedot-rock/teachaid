...
(function (global) {
  ...
  var BUILTIN_BOOKS = {
    ...
    col_finance: {
      title: "Financial Practices 101",
      teacher: "Vera",
      teacherBlurb: "Budgets, credit, and money habits that stick.",
      avatar: "V",
      track: "college",
      order: 17,
      tag: "FIN 101",
      tagStyle: "background:rgba(251,191,36,.12);color:#fbbf24",
      card: "Budget, credit, saving, and everyday money skills",
      ch: [
        ch("Welcome",
          "<h2>Financial Practices 101</h2><p>Money skills are habits: track, plan, choose, and protect yourself.</p>" +
            teach("Vera", "Vera teaches only Financial Practices 101."),
          "Chapter: Welcome. Financial practices: track, plan, choose, protect. Teacher Vera."),
        ch("Budget",
          "<h2>Budget basics</h2><p>Income − needs − wants − savings goals. A budget is a plan, not a punishment. Start with what you actually spend for two weeks.</p>" +
            idea("Rule of thumb", "Pay yourself first — automate a small savings transfer."),
          "Chapter: Budget. Plan income vs needs, wants, savings. Track real spending; automate savings."),
        ch("Credit",
          "<h2>Credit & debt</h2><p>Credit scores reflect payment history and debt use. High-interest debt grows fast. Borrow only with a clear payoff plan.</p>",
          "Chapter: Credit. Scores reflect history and utilization; high-interest debt compounds; plan payoffs."),
        ch("Protect",
          "<h2>Protect your money</h2><p>Emergency fund, basic insurance awareness, phishing scams, and never share one-time codes. If it sounds free and urgent, slow down.</p>",
          "Chapter: Protect. Emergency fund, insurance basics, scam awareness, never share codes."),
        ch("Goals",
          "<h2>Goals & review</h2><p>Short goals (month) and long goals (year+). Review monthly. Adjust without shame — practices improve with practice.</p>" +
            fin("Financial Practices 101 · core complete"),
          "Chapter: Goals. Short and long money goals; monthly review; iterate habits."),
      ],
    },
    col_network: {
      title: "Networking 101",
      teacher: "Lin",
      teacherBlurb: "People, not just contacts — genuine professional connection.",
      avatar: "L",
      track: "college",
      order: 18,
      tag: "NET 101",
      tagStyle: "background:rgba(56,189,248,.12);color:#7dd3fc",
      card: "Professional relationships and opportunity",
      ch: [
        ch("Welcome",
          "<h2>Networking 101</h2><p>Networking is building genuine professional relationships — not collecting business cards like trophies.</p>" +
            teach("Lin", "Lin teaches only Networking 101."),
          "Chapter: Welcome. Networking = genuine professional relationships. Teacher Lin."),
        ch("Mindset",
          "<h2>Give-first mindset</h2><p>Lead with curiosity and value: intros, resources, encouragement. People remember how you made them feel.</p>",
          "Chapter: Mindset. Give first — curiosity, value, warm intros; people remember feelings."),
        ch("Reach out",
          "<h2>Reach out well</h2><p>Short message: who you are, why them (specific), a clear small ask (15-min chat, advice on X). Follow up once politely.</p>",
          "Chapter: Reach out. Short specific messages; clear small ask; one polite follow-up."),
        ch("Events",
          "<h2>Events & online</h2><p>Prepare a 20-second intro. Listen more than you pitch. Online: comment thoughtfully; keep profiles clear and kind.</p>",
          "Chapter: Events. 20-second intro; listen; thoughtful online presence."),
        ch("Maintain",
          "<h2>Maintain ties</h2><p>Light check-ins, share wins, congratulate others. A small network you care for beats a huge list you ignore.</p>" +
            fin("Networking 101 · core complete"),
          "Chapter: Maintain. Check-ins, share wins, congratulate; quality over list size."),
      ],
    },
    col_ai: {
      title: "Artificial Intelligence 101",
      teacher: "Aiden",
      teacherBlurb: "What AI is, what it is not, and how it works at a high level.",
      avatar: "A",
      track: "college",
      order: 19,
      tag: "AI 101",
      tagStyle: "background:rgba(167,139,250,.12);color:#c4b5fd",
      card: "ML basics, models, limits, and everyday AI",
      ch: [
        ch("Welcome",
          "<h2>Artificial Intelligence 101</h2><p><strong>AI</strong> is software that performs tasks that once seemed to need human intelligence — often by learning patterns from data.</p>" +
            teach("Aiden", "Aiden teaches only AI 101."),
          "Chapter: Welcome. AI performs tasks via learned patterns from data. Teacher Aiden."),
        ch("ML basics",
          "<h2>Machine learning basics</h2><p>Models learn from examples (training data). They predict or generate based on patterns — they do not “understand” like people do.</p>" +
            idea("Key idea", "Garbage in → garbage out. Data quality matters."),
          "Chapter: ML basics. Models train on examples; predict/generate patterns; no human-like understanding; data quality matters."),
        ch("Types",
          "<h2>Kinds of AI you meet</h2><ul><li>Classification / recommendation</li><li>Computer vision & speech</li><li>Generative models (text, image, code)</li><li>Agents that chain tools</li></ul>",
          "Chapter: Types. Classification, recsys, vision/speech, generative models, tool-using agents."),
        ch("Limits",
          "<h2>Limits & failure modes</h2><p>Hallucinations, bias from data, privacy risks, overconfidence. Always verify important outputs.</p>",
          "Chapter: Limits. Hallucinations, bias, privacy, overconfidence; verify important outputs."),
        ch("Use well",
          "<h2>Using AI well</h2><p>Clear goals, good prompts, human review, cite sources when needed. AI is a tool — you stay accountable.</p>" +
            fin("Artificial Intelligence 101 · core complete"),
          "Chapter: Use well. Clear goals, prompts, human review, accountability."),
      ],
    },
    col_aihuman: {
      title: "AI / Human Cohesion 101",
      teacher: "Harmony",
      teacherBlurb: "Working with AI without losing the human plot.",
      avatar: "H",
      track: "college",
      order: 20,
      tag: "AI 101",
      tagStyle: "background:rgba(167,139,250,.12);color:#c4b5fd",
      card: "Partnership, trust, and human strengths with AI",
      ch: [
        ch("Welcome",
          "<h2>AI / Human Cohesion 101</h2><p>Best results come when humans and AI systems <strong>complement</strong> each other — not when one replaces judgment.</p>" +
            teach("Harmony", "Harmony teaches only AI/Human Cohesion 101."),
          "Chapter: Welcome. Humans and AI complement; judgment stays human. Teacher Harmony."),
        ch("Strengths",
          "<h2>Who is good at what</h2><p><strong>AI:</strong> speed, draft, search, pattern scale. <strong>Humans:</strong> values, context, accountability, empathy, novel ethics.</p>",
          "Chapter: Strengths. AI: speed/draft/patterns. Humans: values, context, accountability, empathy."),
        ch("Trust",
          "<h2>Trust calibration</h2><p>Neither blind trust nor total rejection. Match trust to risk: low-stakes drafts vs medical, legal, or safety decisions.</p>",
          "Chapter: Trust. Calibrate trust to risk; high-stakes need verification and experts."),
        ch("Workflow",
          "<h2>Healthy workflows</h2><p>Define the goal → use AI for options/drafts → human edits → check facts → own the final call. Document when AI helped if required.</p>",
          "Chapter: Workflow. Goal → AI draft → human edit → fact-check → own final; document AI use when needed."),
        ch("Culture",
          "<h2>Teams & culture</h2><p>Teach literacy, set norms, protect privacy, and keep dignity at work. Cohesion is social as much as technical.</p>" +
            fin("AI / Human Cohesion 101 · core complete"),
          "Chapter: Culture. Literacy, norms, privacy, dignity; cohesion is social and technical."),
      ],
    },
    col_cyber: {
      title: "Cybersecurity 101",
      teacher: "Cy",
      teacherBlurb: "Passwords, phishing, and safer digital life.",
      avatar: "C",
      track: "college",
      order: 21,
      tag: "SEC 101",
      tagStyle: "background:rgba(248,113,113,.12);color:#fca5a5",
      card: "Basic security hygiene for everyone",
      ch: [
        ch("Welcome",
          "<h2>Cybersecurity 101</h2><p>Security is protecting accounts, devices, and data from misuse — starting with everyday habits.</p>" +
            teach("Cy", "Cy teaches only Cybersecurity 101."),
          "Chapter: Welcome. Protect accounts, devices, data via everyday habits. Teacher Cy."),
        ch("Passwords",
          "<h2>Passwords & MFA</h2><p>Unique passwords (manager helps). Turn on multi-factor authentication. Never reuse the same password for email and banking.</p>",
          "Chapter: Passwords. Unique passwords, password manager, MFA; no reuse on critical accounts."),
        ch("Phishing",
          "<h2>Phishing & social engineering</h2><p>Urgent + fear + link is a classic trap. Hover before you click. Verify odd requests out-of-band.</p>",
          "Chapter: Phishing. Urgent fear links; verify out-of-band; hover before click."),
        ch("Devices",
          "<h2>Devices & updates</h2><p>Keep OS and apps updated. Lock screens. Be careful on public Wi‑Fi for sensitive logins.</p>",
          "Chapter: Devices. Updates, lock screens, caution on public Wi-Fi for sensitive logins."),
        ch("Data",
          "<h2>Data care</h2><p>Share less by default. Back up what matters. Know privacy settings on social apps.</p>" +
            fin("Cybersecurity 101 · core complete"),
          "Chapter: Data. Minimize sharing, backups, privacy settings."),
      ],
    },
    col_data: {
      title: "Data Literacy 101",
      teacher: "Dara",
      teacherBlurb: "Read charts, question data, spot spin.",
      avatar: "D",
      track: "college",
      order: 22,
      tag: "DATA 101",
      tagStyle: "background:rgba(94,234,212,.12);color:#5eead4",
      card: "Charts, averages, and honest data reading",
      ch: [
        ch("Welcome",
          "<h2>Data Literacy 101</h2><p>Data literacy means reading numbers and charts critically — and knowing what they do <em>not</em> say.</p>" +
            teach("Dara", "Dara teaches only Data Literacy 101."),
          "Chapter: Welcome. Critical reading of numbers and charts. Teacher Dara."),
        ch("Charts",
          "<h2>Charts that mislead</h2><p>Cut axes, cherry-picked ranges, 3D junk. Always check scale, source, and sample.</p>",
          "Chapter: Charts. Misleading scales and cherry-picks; check scale, source, sample."),
        ch("Averages",
          "<h2>Averages & distributions</h2><p>Mean vs median matters with outliers. Ask: average of what population?</p>",
          "Chapter: Averages. Mean vs median; outliers; define the population."),
        ch("Claims",
          "<h2>Claims from data</h2><p>Correlation ≠ causation. Small samples exaggerate. Missing context changes meaning.</p>",
          "Chapter: Claims. Correlation not causation; sample size; context."),
        ch("Practice",
          "<h2>Practice habit</h2><p>Before sharing a stat: source? date? definition? who benefits if you believe it?</p>" +
            fin("Data Literacy 101 · core complete"),
          "Chapter: Practice. Source, date, definition, incentives before sharing stats."),
      ],
    },
    col_digital: {
      title: "Digital Literacy 101",
      teacher: "Dot",
      teacherBlurb: "Search, evaluate, create, and stay safe online.",
      avatar: "D",
      track: "college",
      order: 23,
      tag: "DIG 101",
      tagStyle: "background:rgba(94,234,212,.12);color:#5eead4",
      card: "Search, evaluate, and thrive online",
      ch: [
        ch("Welcome",
          "<h2>Digital Literacy 101</h2><p>Skills to find, evaluate, create, and communicate with digital tools — thoughtfully.</p>" +
            teach("Dot", "Dot teaches only Digital Literacy 101."),
          "Chapter: Welcome. Find, evaluate, create, communicate digitally. Teacher Dot."),
        ch("Search",
          "<h2>Search well</h2><p>Use specific keywords, site filters, and multiple sources. First result is not always best.</p>",
          "Chapter: Search. Specific keywords, filters, multiple sources; rank ≠ quality."),
        ch("Evaluate",
          "<h2>Evaluate sources</h2><p>Author, date, evidence, bias, and whether others corroborate. Be wary of outrage farms.</p>",
          "Chapter: Evaluate. Author, date, evidence, bias, corroboration."),
        ch("Create",
          "<h2>Create & cite</h2><p>Respect copyright and licenses. Credit images and quotes. Your digital footprint is long-lived.</p>",
          "Chapter: Create. Copyright, licenses, credit, digital footprint."),
        ch("Wellbeing",
          "<h2>Attention & wellbeing</h2><p>Notifications are designed to pull you. Set boundaries. Offline time is part of literacy.</p>" +
            fin("Digital Literacy 101 · core complete"),
          "Chapter: Wellbeing. Notification boundaries; offline time is literacy too."),
      ],
    },
    col_art: {
      title: "Art 101",
      teacher: "Aria",
      teacherBlurb: "See form, color, and meaning in art.",
      avatar: "A",
      track: "college",
      order: 24,
      tag: "ART 101",
      tagStyle: "background:rgba(244,114,182,.12);color:#f9a8d4",
      card: "Looking at art with language and curiosity",
      ch: [
        ch("Welcome",
          "<h2>Art 101</h2><p>Art is human making that invites looking, feeling, and thinking — across media and cultures.</p>" +
            teach("Aria", "Aria teaches only Art 101."),
          "Chapter: Welcome. Art invites looking, feeling, thinking across media. Teacher Aria."),
        ch("Elements",
          "<h2>Elements of art</h2><p>Line, shape, color, value, texture, space, form. Artists arrange these on purpose.</p>",
          "Chapter: Elements. Line, shape, color, value, texture, space, form."),
        ch("Principles",
          "<h2>Principles of design</h2><p>Balance, contrast, emphasis, movement, rhythm, unity. Composition guides the eye.</p>",
          "Chapter: Principles. Balance, contrast, emphasis, movement, rhythm, unity."),
        ch("Context",
          "<h2>Context & meaning</h2><p>When and where a work was made shapes meaning. Your response is valid — and informed by learning context.</p>",
          "Chapter: Context. Time/place shape meaning; personal response plus context."),
        ch("Practice",
          "<h2>Looking practice</h2><p>Describe → analyze → interpret → evaluate. Spend a full minute with one work before judging.</p>" +
            fin("Art 101 · core complete"),
          "Chapter: Practice. Describe, analyze, interpret, evaluate; slow looking."),
      ],
    },
    col_lit: {
      title: "Literature 101",
      teacher: "Lyra",
      teacherBlurb: "Stories, poems, and close reading.",
      avatar: "L",
      track: "college",
      order: 25,
      tag: "LIT 101",
      tagStyle: "background:rgba(244,114,182,.12);color:#f9a8d4",
      card: "Close reading of stories and poems",
      ch: [
        ch("Welcome",
          "<h2>Literature 101</h2><p>Literature uses language as art: stories, poems, plays that repay careful reading.</p>" +
            teach("Lyra", "Lyra teaches only Literature 101."),
          "Chapter: Welcome. Literature as artful language: fiction, poetry, drama. Teacher Lyra."),
        ch("Close read",
          "<h2>Close reading</h2><p>Notice word choice, images, structure, and what is left unsaid. Quote evidence for claims.</p>",
          "Chapter: Close reading. Diction, imagery, structure, silence; evidence for claims."),
        ch("Story",
          "<h2>Story elements</h2><p>Character, setting, conflict, plot, point of view, theme. How form shapes feeling.</p>",
          "Chapter: Story. Character, setting, conflict, plot, POV, theme."),
        ch("Poetry",
          "<h2>Poetry basics</h2><p>Line breaks, sound, metaphor, and compression. Read aloud when you can.</p>",
          "Chapter: Poetry. Line breaks, sound, metaphor, compression; read aloud."),
        ch("Talk back",
          "<h2>Talk back to texts</h2><p>Agree, argue, connect to life — with respect for the text. Literature is a conversation across time.</p>" +
            fin("Literature 101 · core complete"),
          "Chapter: Talk back. Argue and connect with respect; literature as conversation."),
      ],
    },
    col_law: {
      title: "Intro to Law",
      teacher: "Lex",
      teacherBlurb: "Rights, systems, and how law thinks.",
      avatar: "L",
      track: "college",
      order: 26,
      tag: "LAW 101",
      tagStyle: "background:rgba(251,146,60,.12);color:#fdba74",
      card: "Legal systems, rights, and civic basics",
      ch: [
        ch("Welcome",
          "<h2>Intro to Law</h2><p>Law is a system of rules and institutions that resolve disputes, allocate power, and protect rights — imperfectly, and differently by place.</p>" +
            teach("Lex", "Lex teaches only Intro to Law. Not legal advice."),
          "Chapter: Welcome. Law as rules and institutions; not legal advice. Teacher Lex."),
        ch("Sources",
          "<h2>Sources of law</h2><p>Constitutions, statutes, regulations, case law (precedent). Hierarchy matters when rules conflict.</p>",
          "Chapter: Sources. Constitutions, statutes, regulations, case law; hierarchy."),
        ch("Civil vs criminal",
          "<h2>Civil vs criminal</h2><p><strong>Criminal:</strong> state prosecutes wrongs against society. <strong>Civil:</strong> private disputes (contracts, torts). Different burdens and remedies.</p>",
          "Chapter: Civil vs criminal. State vs private disputes; burdens and remedies differ."),
        ch("Rights",
          "<h2>Rights & process</h2><p>Due process, equal protection ideas, and procedural fairness. Rights have limits and evolve through courts and legislatures.</p>",
          "Chapter: Rights. Due process, equality ideas, procedural fairness; rights evolve."),
        ch("Civic",
          "<h2>Civic literacy</h2><p>How to find official sources, when to seek a licensed attorney, and how to read a holding carefully. This course is education — not counsel for your case.</p>" +
            fin("Intro to Law · core complete"),
          "Chapter: Civic. Official sources; licensed counsel for real cases; education not advice."),
      ],
    },
  ...
  var TRACKS = [
    ...
    },
    {
      ...
      blurb: "Gen-ed, AI & tech, arts, law, finance, networking, and more",
    },
  ];
